...
var StepForm = React.createClass({
    ...
    render: function () {
        ...
        var displayInput = operation === 'input' || operation === 'select' || operation === 'text' ? 'block' : 'none';
                        ...
                        <div className={"form-group"}>
                            ...
                            <select
                                ...
                                onChange={this.setOp} >
                                    ...
                                    <option value="move">鼠标进入</option>
                                    <option value="down">鼠标按下</option>
                                    <option value="up">鼠标松开</option>
                                    
                                    <option value="input">输入文本</option>
                                    <option value="select">选择</option>

                                    <option value="exist">元素存在</option>
